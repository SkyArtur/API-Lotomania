...
if DJANGO_ENV == 'development' or DJANGO_ENV == 'test':
    database_url = ENV('DEV_DATABASE_URL', default=f'sqlite:////{BASE_DIR/ "db.sqlite3"}')
else:
...
CELERY_BEAT_SCHEDULE = {
    'atualizar-sorteios': {
        'task': 'core.tasks.atualizar_sorteios_task',
